      ...
      <div className="container mx-auto px-6">
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
          ...
          <div>
            ...
            <div className="space-y-3">
              {["About", "Projects", "Experience", "Tech"].map((item) => (
                <motion.a
                  key={item}
        ...
        <div className="mt-12 pt-8 border-t border-gray-200 text-center text-gray-600">
          <p>© {new Date().getFullYear()} Leandro Bernal. All rights reserved.</p>
        </div>
      </div>
      <PastVersionsModal isOpen={isModalOpen} onClose={() => setIsModalOpen(false)} />
    </footer>
  )
}
