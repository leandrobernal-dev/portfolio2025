    ...
    return (
        <section className="min-h-screen flex items-center justify-center relative py-16 overflow-hidden bg-[#f0f0f3] dark:bg-[#0f0f0f]">
            <div className="container mx-auto px-2 relative">
                ...
                >
                    <div 
                        className="text-[20vw] lg:text-[15vw] xl:text-[12vw] font-black tracking-wider select-none dark:hidden"
                        style={{
                            textShadow: `
                ...
                >
                    ...
                    >
                        ...
                        <motion.h1
                            ...
                            className="text-6xl sm:text-7xl md:text-8xl lg:text-9xl xl:text-[10rem] font-black tracking-tight text-gray-800 dark:text-gray-100 leading-none mb-8"
                            style={{
                                textShadow: `
                        ...
                        <motion.div
                            ...
                            className="space-y-4"
                        >
                            <p className="text-xl lg:text-2xl xl:text-3xl text-gray-600 dark:text-gray-400 font-medium max-w-3xl mx-auto leading-relaxed">
                        ...
                        >
                            <motion.a
                                href="#work"
                                className="group relative inline-flex items-center gap-4 px-10 py-5 text-gray-800 dark:text-gray-200 font-bold tracking-wider text-lg overflow-hidden"
