                        ...
                        <div className="space-y-6 text-gray-700 text-lg leading-relaxed">
                            <div className="neuro-card-inset p-6">
                                <p>
                                    ...
                                    , now I build websites 🔨🤖➡️🌐. I've been
                                    freelancing for{" "}
                                    <strong className="text-gray-800">
                                        3 years
                                    </strong>{" "}
                                    now, building and maintaining websites and
                            ...
                            <div className="neuro-card-inset p-6">
                                <p>
                                    ...
                                    . When I start building a new personal
                                    project, Next.js helps me quickly and
                                    efficiently bring ideas to life. It allows
                                    for rapid testing and iteration, making it
                                    perfect for exploring new concepts and
